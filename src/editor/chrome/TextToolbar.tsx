...
import { allowedBackgroundColors, allowedTextColors } from '@/html/authorHtml'
import type { EditorSelection } from '../input/dom'
import { createRangeReference } from '../input/dom'
