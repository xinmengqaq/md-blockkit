...
import { highlightCode } from '@/html/syntaxHighlight'

import type { CodeBlock as CodeBlockType } from '@/model/types'
...
export const CodeBlock = ({ block, readOnly, onChange }: CodeBlockProps) => {
  ...
  return (
    <div className="block-editor__code">
      ...
      <label className="block-editor__visually-hidden" htmlFor={textareaId}>
        代码内容
      </label>
      <div
